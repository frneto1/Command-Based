...
public class RobotContainer{
  ...
  public Autonomous auto = new Autonomous(driveSubsystem, ir, limelight);

  public RobotContainer() {
    driveSubsystem.setDefaultCommand(new Locomocao(driveSubsystem, calcs, bob, roberto, ejector));
    getAutonomous();
  }
